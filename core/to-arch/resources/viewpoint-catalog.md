...
> to-arch bundled copy - provenance: `docs/templates/VIEWPOINT-CATALOG.md` in the Skills workspace (2026-08-26). If the project carries its own copy at that path, the project-local file takes precedence.
