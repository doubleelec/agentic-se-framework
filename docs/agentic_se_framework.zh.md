...
<ul>
  ...
  <li>英文版：<a href="agentic_se_framework.en.md"><code>agentic_se_framework.en.md</code></a>（本地副本）。两份文档章节编号、表格结构、图的几何保持一致；中文版为内容修订的源真理。</li>
